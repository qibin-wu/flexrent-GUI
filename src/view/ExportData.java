...
public class ExportData {
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			Button button = new Button("Choose Folder to Export all Data");

			button.setOnAction(new ExportDataListener(primaryStage));
			root.setCenter(button);

			vbox.getChildren().addAll(menuBar, root);

			Scene scene = new Scene(vbox);
			primaryStage.setTitle("Export Data"); // Set the stage title
