...
public class Maintenance {
	...
	public Maintenance(FlexRent flexrent) {
		...
		Button btnSummit = new Button("Start Maintenance");
		btnSummit.setOnAction(e -> {
			...
			try {
				...
				flexrent.propertyMaintenance(property);

				Alert alert = new Alert(AlertType.INFORMATION);
				alert.setTitle("Perform Maintenance successfully");
				alert.setHeaderText(null);
				alert.setContentText(property.getProType() + " " + property.getPid() + " is now under maintenance");
				alert.showAndWait();
			...
			catch (performMaintenanceException pmE) {
	...
	public Maintenance(FlexRent flexrent, Property property) {
		Stage primaryStage = new Stage();
